...
import {
  MessageSquare, Sparkles, Coins, User, Volume2, 
  Image as ImageIcon, Clock, Flame, Compass, 
  Sliders, Check, X, Award, Send, Zap, Copy, 
  Info, CheckCircle2, LockKeyhole, LogOut, Shield
} from 'lucide-react';

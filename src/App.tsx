...
const STRANGER_PERSONAS: StrangerPersona[] = [
  {
    ...
    replies: [
      ...
      { keywords: ['секрет'], text: 'Мой секрет: я пою в караоке дома...' }
    ],
  ...
  },
  {
    ...
    replies: [
      ...
      { keywords: ['секрет'], text: 'Удалил файл на проде и восстановил за 5 минут.' }
    ],
...
export default function App() {
  ...
  const [chatTimer, setChatTimer] = useState(900); // 15 mins
  
  // --- State: Actions & Economy ---
  ...
  const handleSendPhotoMock = () => {
    ...
    // Mock photo send
    setChatMessages(prev => [...prev, {
      id: `media-${Date.now()}`, sender: 'user', type: 'media',
      text: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=400&q=80',
      time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
    }]);
  };
  ...
  // ============================================
  // 🎨 RENDER (Mobile Only Layout)
  // ============================================
  return (
    <div className="min-h-screen bg-[#050506] text-white flex flex-col max-w-md mx-auto w-full relative overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto bg-radial-gradient-lobby">
        ...
        {activeTab === 'chat' && (
          <div className="flex flex-col h-full">
                ...
                <div key={msg.id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                  {msg.sender === 'system' ? (
                    ...
                    <div className="max-w-[80%] rounded-2xl overflow-hidden">
                      <img src={msg.text} alt="media" className="rounded-xl max-h-40 object-cover" />
                    </div>
                  ) : (
            ...
            <div className="p-3 border-t border-white/[0.05] bg-[#101012] flex gap-2">
            ...
            <div className="px-3 py-2 border-t border-white/[0.05] bg-[#0A0A0B] flex justify-between">
                  ...
                  {['all', 'male', 'female'].map(g => (
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-xs ${
                        'all' === g ? 'bg-purple-600' : 'bg-white/5'
                      }`}
                    >

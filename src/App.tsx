...
============================================================
FILE: src/ModerationDashboard.tsx
============================================================
import { useState } from 'react';
import { Shield, AlertTriangle, XCircle, Ban, Eye, Star } from 'lucide-react';
...
export default function ModerationDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-gray-100 p-4 md:p-8 font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {cases.map(c => (
                ...
                >
                  ...
                  <div className="text-xs text-gray-400 mt-1">
                    Причина: {c.reason === 'inappropriate_media' ? '📸 NSFW контент' : '💬 Харассмент'}
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="lg:col-span-2">
            {selectedCase ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-gray-500 bg-[#1C1C1F]/50 rounded-2xl border border-white/5 min-h-[400px]">

...
import {
  MessageSquare, Sparkles, Shield, Coins, Lock, User, Volume2, 
  Image as ImageIcon, Clock, Flame, Share2, LogOut, Compass, 
  Sliders, Check, X, Award, RefreshCw, Send, Zap, Copy, Info, 
  CheckCircle2, LockKeyhole, AlertTriangle
} from 'lucide-react';
...
const userName = telegramUser ? `${telegramUser.first_name || 'User'}` : 'Demo User';

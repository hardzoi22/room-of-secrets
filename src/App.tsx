    ...
    <div className="fixed inset-0 h-[100dvh] w-full bg-[#030305] text-white flex flex-col overflow-hidden select-none">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="text-center w-full">
          ...
          {/* Надёжно центрированная кнопка */}
          <div className="flex justify-center">
            <button 
              onClick={() => alert('Поиск собеседника... (функция в разработке)')}
              className="relative w-40 h-40 rounded-3xl bg-gradient-to-br from-purple-600 via-violet-600 to-indigo-600 flex flex-col items-center justify-center shadow-2xl shadow-purple-500/60 hover:scale-105 active:scale-95 transition-all group overflow-hidden mx-auto"
            >
